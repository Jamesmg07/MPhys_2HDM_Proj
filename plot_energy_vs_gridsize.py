...
plot_output_dir = r"c:\Users\zaink\OneDrive\Documents\MPhys Project\MPhys_2HDM_Proj\Report_Plots\output"
...
def plot_energy_vs_gridsize(data_file_path, output_dir=None):
    ...
    if output_dir is None:
        output_dir = plot_output_dir  # Use the configurable plot output directory
...
def main():
    ...
    for csv_file in csv_files:
        ...
        try:
            plot_energy_vs_gridsize(csv_file, plot_output_dir)
        except Exception as e:
