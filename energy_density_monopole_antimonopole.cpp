...
const string outTag = "gamma=" + to_string(gamma_mult) + "pi_nx=" + to_string(nx) + "_seed=" + to_string(seed) + "_monopole" ;
...
int main(int argc, char** argv) {
    ...
    if (save_separation_energy && rank == 0) {
        string sepEnergyPath = out_path + "separation_vs_energy_gamma=" + to_string(gamma_mult) + "pi_nx=" + to_string(nx) + "_seed=" + to_string(seed) + ".csv";
