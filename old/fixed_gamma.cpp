...
const string out_path = "/share/centaurus_nas/jmg_temp/fixed_SOR/"; // Data Directory Location - fixed path

// === NEW: Arrays for triple nested loop ===
const vector<double> separations = {{0.1,
    0.2250, 0.2275, 0.2300, 0.2325, 0.2350, 0.2375, 0.2400, 0.2425, 0.2450, 0.2475,
    0.2500, 0.2525, 0.2550, 0.2575, 0.2600, 0.2625, 0.2650, 0.2675, 0.2700, 0.2725, 0.2750, 0.4
};}; // Different separation values to test
const vector<double> gamma_mult_1_values = {0.5}; // Array of gamma_1 values to test
const vector<double> gamma_mult_2_values = {0.5}; // Array of gamma_2 values to test
