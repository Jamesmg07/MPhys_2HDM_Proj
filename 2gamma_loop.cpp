...
const string out_path = "/share/centaurus_nas/mkza/Week_6/2gamma_loop_test/"; // Data Directory Location - fixed path

// === NEW: Arrays for triple nested loop ===
const vector<double> separations = {0.1, 0.25, 0.5}; // Different separation values to test
